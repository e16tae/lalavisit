        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div id="phone-section" className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 rounded-2xl text-center">
              ...
              <div className="space-y-3 mb-6">
                <div>
                  ...
                  <a href="tel:02-430-2351" className="text-lg font-semibold text-primary hover:underline">
                    02-430-2351
                  </a>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">팩스</p>
                  <span className="text-lg font-semibold text-primary">02-430-2352</span>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">대표자</p>
                  <a href="tel:010-9573-2351" className="text-lg font-semibold text-primary hover:underline">
                    010-9573-2351
                  </a>
                </div>
              </div>
            ...
            <div id="kakao-section" className="bg-gradient-to-br from-[#FEE500]/30 to-[#FEE500]/10 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-600 mb-6">실시간 채팅으로 빠른 상담이 가능합니다</p>
            ...
            <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-600 mb-6">언제든지 이메일로 문의하세요</p>
              <a href="mailto:lalavisit@naver.com" className="text-lg font-semibold text-secondary hover:underline">
                lalavisit@naver.com
              </a>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">정보를 입력하시면 빠른 시일 내에 연락드리겠습니다</p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-700">
                    ...
                    <p className="text-sm text-gray-600 mt-4">언제든지 편하신 시간에 연락 주시면 친절하게 상담해 드리겠습니다.</p>
                    <p className="text-sm text-gray-600">※ 긴급한 경우 대표자 휴대폰(010-9573-2351)으로 연락 주시기 바랍니다.</p>
                  </div>
                </div>
              </div>
            </div>
